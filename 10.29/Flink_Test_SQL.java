...
public class Flink_Test_SQL {
    public static void main(String[] args) throws Exception {
        ...
        tenv.executeSql(
                "CREATE TABLE t_kafka_gmv_topn_sink ( " +
                        "  order_date STRING, " +
                        "  window_start TIMESTAMP(3), " +  // 改为 TIMESTAMP
                        "  window_end TIMESTAMP(3), " +    // 改为 TIMESTAMP
                        "  gmv DECIMAL(38, 2), " +         // 改为 DECIMAL
                        "  top5_ids STRING, " +
        ...
        tenv.executeSql(
                "INSERT INTO t_kafka_gmv_topn_sink \n" +
                "WITH window_gmv AS (\n" +
                        "    SELECT \n" +
                        "        window_start,\n" +
                        "        window_end,\n" +
